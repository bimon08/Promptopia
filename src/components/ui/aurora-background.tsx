...
export const AuroraBackground = ({
  ...
  return (
    <main className="overflow-x-hidden">
      ...
      <div
        className={cn(
          "transition-bg relative overflow-x-hidden flex min-h-screen w-full flex-col items-center justify-center overflow-y-auto bg-zinc-50 text-slate-950 dark:bg-zinc-900", // Allows vertical scroll
          className,
        )}
        {...props}
      >
